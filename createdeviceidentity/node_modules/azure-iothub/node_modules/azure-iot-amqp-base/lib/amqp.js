...
var debug = dbg('amqp-common:amqp');
                ...
                connecting: {
                    _onEnter: function (connectCallback) {
                        ...
                        var amqpErrorHandler = function (err) {
                            ...
                            _this._fsm.handle('amqpError', err, function () {
                        ...
                        _this._amqp.connect(_this.uri)
                            ...
                            _this._safeCallback(connectCallback, connectError || err);
                        });
                    },
                    ...
                    _onEnter: function (disconnectCallback, err) {
                        var disconnect = function (callback) {
                            if (err) {
                                ...
                                _this._amqp.removeAllListeners('disconnected');
