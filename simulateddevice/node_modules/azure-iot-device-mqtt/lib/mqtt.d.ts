...
import { Message, X509, Receiver } from 'azure-iot-common';
 ...
 */
export declare class Mqtt extends EventEmitter implements Client.Transport, StableConnectionTransport, TwinTransport, Receiver {
    /**
     * @private
     */
